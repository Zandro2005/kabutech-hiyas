...
export default function StaffCropScreen() {
  ...
  const openActionModal = (type: 'harvest' | 'flag', rack: BatchData) => {
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            {/* Page Title */}
            <View style={tw`mb-6`}>
              <Text style={[tw`text-[17px] text-[#032514] dark:text-slate-100 tracking-tight`, {fontFamily: 'PlusJakartaSans_800ExtraBold'}]}>Active Crops</Text>
              <Text style={[tw`text-xs text-gray-500 dark:text-slate-400 mt-1`, {fontFamily: 'PlusJakartaSans_400Regular'}]}>View rack health and log your harvests here.</Text>
            </View>
            ...
            <View style={tw`flex-row justify-between items-center mb-4 mt-2`}>
              <Text style={[tw`text-[15px] text-[#032514] dark:text-slate-200 tracking-tight`, {fontFamily: 'PlusJakartaSans_800ExtraBold'}]}>Racks Overview</Text>
            </View>
          </View>
        }
        ListEmptyComponent={
          <View style={tw`bg-white dark:bg-slate-800 rounded-[24px] p-8 items-center justify-center border border-dashed border-gray-300 dark:border-slate-600`}>
            ...
            <Text style={[tw`text-gray-400 dark:text-slate-500 text-xs mt-1 text-center`, {fontFamily: 'PlusJakartaSans_400Regular'}]}>An admin needs to initialize a batch first.</Text>
          </View>
        }
          ...
          <View style={tw`bg-white dark:bg-slate-800 rounded-[24px] p-5 shadow-sm border border-gray-100 dark:border-slate-700 mb-4 overflow-hidden`}>
            ...
            <View style={tw`flex-row items-center border-t border-gray-50 dark:border-slate-700 pt-3 gap-2`}>
              ...
              >
                ...
                <Text style={[tw`text-[10px] text-red-600 dark:text-red-400`, {fontFamily: 'PlusJakartaSans_800ExtraBold'}]}>Flag Issue</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
