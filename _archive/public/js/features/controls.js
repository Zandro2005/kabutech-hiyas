...
function applyModeUI(mode) {
    ...
    if (mode === 'auto') {
        if (btnAuto) btnAuto.className = "px-3 py-1.5 rounded-full bg-primary text-on-primary font-bold text-[11px] transition-all duration-300";
        if (btnManual) btnManual.className = "px-3 py-1.5 rounded-full text-on-surface-variant dark:text-zinc-400 font-bold text-[11px] transition-all duration-300";
        if (warnLabel) warnLabel.classList.add('hidden');
    } else {
        if (btnManual) btnManual.className = "px-3 py-1.5 rounded-full bg-warning-gold text-white font-bold text-[11px] transition-all duration-300";
        if (btnAuto) btnAuto.className = "px-3 py-1.5 rounded-full text-on-surface-variant dark:text-zinc-400 font-bold text-[11px] transition-all duration-300";
